...
// router.get('/update/:code', auth, subscriptions.updateSubscription);
// router.post('/disable', auth, subscriptions.disableSubscription);
// router.post('/enable', auth, subscriptions.enableSubscription);
